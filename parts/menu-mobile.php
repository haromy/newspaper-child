...
<div id="td-mobile-nav">
    <div class="td-mobile-container">
        ...
        <div class="td-mobile-content menu2">
            <?php
            wp_nav_menu(array(
        ...
        <div class="container-fluid network">
            ...
            <div class="row">
                <div class="col-6">
                    <a href="https://geotimes.co.id/" target="_blank"><img class="logonetwork" src="<?php echo get_stylesheet_directory_uri().'/logo/geotimes.png';?>"></a>
                </div>
                <div class="col-6">
                    <a href="http://historia.id/" target="_blank"> <img class="logonetwork" src="<?php echo get_stylesheet_directory_uri().'/logo/historiaid.png';?>"></a>
                </div>
                <div class="col-6">
