                            ...
                            <div class="container-fluid mgid">
                                <div class="row">
                                    <div class="container">
                                        <div class="col-12">
                                            <?php
                                                $tds_custom_ad_5_title = td_util::get_option('tds_custom_ad_5_title');
                                                // ad spot
                                                echo td_global_blocks::get_instance('td_block_ad_box')->render(array('spot_id' => 'custom_ad_5', 'spot_title' => $tds_custom_ad_5_title));
                                            ?>
                                        </div>
                                    </div>
                                </div>
